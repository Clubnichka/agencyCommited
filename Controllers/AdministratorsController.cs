...
namespace agency.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public AdministratorsController(agencyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Administrator != null ? 
                          ...
                          Problem("Entity set 'agencyContext.Administrator'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password")] Administrator administrator)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'agencyContext.Administrator'  is null.");
            }
            var administrator = await _context.Administrator.FindAsync(id);
            if (administrator != null)
            {
